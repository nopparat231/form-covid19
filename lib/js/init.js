...
$("#outsider_check").submit(function (event) {
  ...
  var $form = $(this),
    ...
    outsider_check_agency = $form.find("input[name='phone']").val(),
    outsider_check_location_out = $form.find("input[name='agency']").val(),
    outsider_check_contact = $form.find("input[name='location_out']").val(),
    outsider_check_location_in = $form.find("input[name='contact']").val(),
    outsider_check_contact_matter = $form
      .find("input[name='location_in']")
      .val(),
    contact_matter = $form.find("input[name='contact_matter']").val(),
  ...
  outsider_check_file = $form.find("input[name='fileupload_name']").val();
